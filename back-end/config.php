...
// Raiz do projeto (pasta que contém front-end/ e back-end/)
...
define('HTML_FILES', [
    SITE_ROOT . 'front-end' . DIRECTORY_SEPARATOR . 'index.html',
    SITE_ROOT . 'front-end' . DIRECTORY_SEPARATOR . 'empresas.html',
    SITE_ROOT . 'front-end' . DIRECTORY_SEPARATOR . 'para-voce.html',
]);
