...
// Já autenticado — ir para o site em modo editor
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!hash_equals($_SESSION['csrf_token'], $_POST['csrf'] ?? '')) {
        ...
        $error = 'Painel não configurado. Defina ADMIN_PASSWORD_HASH em adm/config.php.';
    } else {
        ...
        sleep(1); // Pequeno atraso contra força bruta
...
<head>
  ...
  <title>Administrador Império Corretora</title>
...
<body>
  ...
  <div class="card">
    ...
    <div class="brand">
      ...
      <span class="brand__name">Império Corretora</span>
      <br>
    ...
    <form method="POST" action="/adm/" novalidate>
